...
const A1: Assignment = {
  ...
  steps: [
    ...
    { idx: 4, action: { method: 'extract', description: 'read the order total before applying a coupon', selector: "[data-testid='order-total']" }, label: 'Read total — $84.00', screenshotUrl: null, ms: 410, ok: true,
      digest: { route: '/checkout', title: 'MERIDIAN', meta: 'Cart · 1',
        fields: [{ label: 'Wool scarf, oat', value: '$78.00' }, { label: 'Shipping', value: '$6.00' }], notices: [], controls: [{ kind: 'input', label: 'Coupon code' }, { kind: 'button', label: 'Apply' }],
        primary: { label: 'Total', value: '$84.00' }, flagged: false } },
    ...
    { idx: 7, action: { method: 'extract', description: 'read the order total after applying the coupon', selector: "[data-testid='order-total']" }, label: 'Read total — $84.00 (expected $67.20)', screenshotUrl: null, ms: 460, ok: false,
      digest: { route: '/checkout', title: 'MERIDIAN', meta: 'Cart · 1',
        fields: [{ label: 'Wool scarf, oat', value: '$78.00' }], notices: [{ text: 'Coupon applied — SAVE20, 20% off', tone: 'ok' }], controls: [{ kind: 'input', label: 'Coupon code', value: 'SAVE20' }, { kind: 'button', label: 'Apply' }],
        primary: { label: 'Total', value: '$84.00' }, flagged: true } },
  ],
  network: [
...
const A2: Assignment = {
  ...
  steps: [
    ...
    { idx: 4, action: { method: 'extract', description: 'read the error message and the total', selector: "[data-testid='coupon-error']" }, label: 'Error shown, total $84.00', screenshotUrl: null, ms: 400, ok: true,
      digest: { route: '/checkout', title: 'MERIDIAN', meta: 'Cart · 1',
        fields: [{ label: 'Wool scarf, oat', value: '$78.00' }], notices: [{ text: 'That code is not valid', tone: 'error' }], controls: [{ kind: 'input', label: 'Coupon code', value: 'NOTACODE' }, { kind: 'button', label: 'Apply' }],
        primary: { label: 'Total', value: '$84.00' }, flagged: false } },
  ],
  network: [
...
const A3: Assignment = {
  ...
  steps: [
    ...
    { idx: 4, action: { method: 'observe', description: 'confirm no coupon input on the cart', selector: "input[name='coupon']" }, label: 'No coupon field on /cart', screenshotUrl: null, ms: 490, ok: true,
      digest: { route: '/cart', title: 'MERIDIAN', meta: 'Cart · 1',
        fields: [{ label: 'Wool scarf, oat', value: '$78.00' }], notices: [], controls: [],
        primary: { label: 'Subtotal', value: '$78.00' }, flagged: false } },
  ],
...
const D1: Assignment = {
  ...
  steps: [
    ...
    { idx: 5, action: { method: 'goto', description: 'open the cart', arguments: ['/cart'] }, label: 'Open /cart — subtotal differs', screenshotUrl: null, baseScreenshotUrl: null, ms: 1240, ok: false,
      digest: { route: '/cart', title: 'MERIDIAN', meta: 'Cart · 2',
        fields: [{ label: 'Wool scarf, oat', value: '$78.00' }, { label: 'Linen throw', value: '$54.00' }], notices: [], controls: [],
        primary: { label: 'Subtotal', value: '$NaN' }, flagged: true },
      baseDigest: { route: '/cart', title: 'MERIDIAN', meta: 'Cart · 2',
        fields: [{ label: 'Wool scarf, oat', value: '$78.00' }, { label: 'Linen throw', value: '$54.00' }], notices: [], controls: [],
        primary: { label: 'Subtotal', value: '$132.00' }, flagged: false } },
